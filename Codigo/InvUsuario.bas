...
Public Function IsConsumableFreeZone(ByVal UserIndex As Integer) As Boolean
    ...
    isTierUser = IsFeatureEnabled("patreon_system") And (UserList(UserIndex).Stats.tipoUsuario = tAventurero Or UserList(UserIndex).Stats.tipoUsuario = tHeroe Or UserList(UserIndex).Stats.tipoUsuario = tLeyenda)
