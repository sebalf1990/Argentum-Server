...
Private Sub UpdateBarcoForgatNix()
    ...
    ' Validar que BarcoNavegandoForgatNix este inicializado
    If BarcoNavegandoForgatNix.Map = 0 Then Exit Sub
    If BarcoNavegandoForgatNix.DockX = 0 Then Exit Sub
    If BarcoNavegandoForgatNix.DockY = 0 Then Exit Sub
...
Private Sub UpdateBarcoNixArghal()
    ...
    ' Validar que BarcoNavegandoNixArghal este inicializado
    If BarcoNavegandoNixArghal.Map = 0 Then Exit Sub
    If BarcoNavegandoNixArghal.DockX = 0 Then Exit Sub
    If BarcoNavegandoNixArghal.DockY = 0 Then Exit Sub
...
Private Sub UpdateBarcoArghalForgat()
    ...
    ' Validar que BarcoNavegandoArghalForgat este inicializado
    If BarcoNavegandoArghalForgat.Map = 0 Then Exit Sub
    If BarcoNavegandoArghalForgat.DockX = 0 Then Exit Sub
    If BarcoNavegandoArghalForgat.DockY = 0 Then Exit Sub
