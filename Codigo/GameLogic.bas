...
Private Function CheckMapRestrictions(ByVal UserIndex As Integer, ByVal Map As Integer) As Boolean
    With UserList(UserIndex)
        ...
        If MapInfo(Map).OnlyGroups And Not .Grupo.EnGrupo Then
            ...
            Exit Function
        End If
        If IsFeatureEnabled("patreon_system") And MapInfo(Map).OnlyPatreon And Not (.Stats.tipoUsuario = tAventurero Or .Stats.tipoUsuario = tHeroe Or .Stats.tipoUsuario = tLeyenda) Then
...
Public Function TileRequiresPatreon(ByVal Map As Integer, ByVal x As Integer, ByVal y As Integer) As Boolean
    ...
    TileRequiresPatreon = IsFeatureEnabled("patreon_system") And MapData(Map, x, y).trigger = e_Trigger.ONLY_PATREON_TILE
    Exit Function
